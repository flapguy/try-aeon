...
import {decodePaymentPayload} from "./utils/paymentUtils.js";
...
const X402BNB_ADDRESS = "0x6e3BCf81d331fa7Bd79Ac2642486c70BEAE2600E";
...
(async () => {
    ...
    //   We want to pay 1 TESTU to TO_ADDRESS 
    ...
    console.log("decoded payment payload:", decodePaymentPayload(paymentPayload));
